...
public class Greedy {
    ...
    static void addIntervalsImproved (BulletInfo b){
        ...
        MapLocation m2 = m1.add(b.getSpeed());
        ...
        float distm1 = pos.distanceTo(m1);

        float dist = distm1 * (float) Math.cos(perp.radiansBetween(Dirm1));

        float hCoordm1 = distm1*(float) Math.sin(perp.radiansBetween(Dirm1)), hCoordm2 = distm1*(float) Math.sin(perp.radiansBetween(Dirm2));
        ...
        if (dirv11 == null || dirv12 == null) {
            ...
            if (-1 <= t && t <= 1) {
                ...
                if (hCoordm1 >= hCoord1 && hCoordm2 <= hCoord1) dirv11 = Dirm1.rotateRightRads(angle);
                hCoord1 = r*(float)Math.sin(perp.radiansBetween(Dirm1.rotateLeftRads(angle)));
                if (hCoordm1 >= hCoord1 && hCoordm2 <= hCoord1) dirv12 = Dirm1.rotateLeftRads(angle);
            }
        }
        ...
        if (dirv21 == null || dirv22 == null) {
            ...
            if (-1 <= t && t <= 1) {
                float angle = (float) Math.acos(t);
                float hCoord1 = r*(float)Math.sin(perp.radiansBetween(Dirm1.rotateLeftRads(angle)));
                if (hCoordm1 >= hCoord1 && hCoordm2 <= hCoord1) dirv21 = Dirm1.rotateLeftRads(angle);
                hCoord1 = r*(float)Math.sin(perp.radiansBetween(Dirm1.rotateRightRads(angle)));
                if (hCoordm1 >= hCoord1 && hCoordm2 <= hCoord1) dirv22 = Dirm1.rotateRightRads(angle);
            }
        }
