...
/*
    ...
    static void messageCutNeutralTree(MapLocation treeLocation) {
        ...
        if(!Gardener.lumberjackBuilt && (rc.getRoundNum() - Gardener.myRound >= 100))
        {
        	MapLocation me = rc.getLocation(); 
        	int x = Math.round(me.x);
            int y = Math.round(me.y);
           	Communication.sendMessage(rc, Communication.NEEDTROOPCHANNEL, x, y, Communication.NEEDLUMBERJACK);
        }
