...
public class Shoot {
    ...
    static boolean tryShoot(RobotController rc, int tries){
        ...
        if (rc.getType() == RobotType.SCOUT) return tryShootScout(rc);
    ...
    static boolean tryShootScout(RobotController rc){
        try {
            RobotInfo[] enemies = rc.senseNearbyRobots(1.04f, rc.getTeam().opponent());
