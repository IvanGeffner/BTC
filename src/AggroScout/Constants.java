...
public class Constants {
    ...
    public static int SAFETYMARGINCHECKTREES = 6000;
    public static int SAFETYMARGINSCOUTS = 3000;
    ...
    static float safetyDistance(RobotController rc, RobotType r){
        if (rc.getType() == RobotType.SCOUT){
            if (r != RobotType.ARCHON && r != RobotType.GARDENER && r != RobotType.LUMBERJACK) return 7;
        }
