...
public class Shoot {
        ...
        static boolean tryShoot(RobotController rc, int tries){
            ...
            for (int i = 0; i < tries && i < Greedy.sortedEnemies.length; ++i){
                ...
                Direction dirRightA = dir.rotateRightDegrees(31);
                Direction dirLeftA = dir.rotateLeftDegrees(31);
                ...
                if (dirRightExact.radiansBetween(dirLeftExact) > Constants.eps){
                    ...
                    ut = x*multiplier - 1;
                    if (oberture > Constants.triadAngle){
                        utTriad = multiplier*x*3.0f - 4;
                    }
                    if (oberture > Constants.pentadAngle && maxOberture > Constants.pentadAngle2){
                        utPentad = multiplier*x*3.0f - 6;
                    }
                    ...
                    if (maxOberture > Constants.pentadAngle2){
                        utTriad = 0;
                        ut = 0;
                    }

                    else if (maxOberture > Constants.triadAngle){
                        ut = 0;
                    }
                    else if (maxOberture > Constants.pentadAngle){
                        utTriad = 0;
                        ut = 0;
                    }
